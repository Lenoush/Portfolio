  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-6">
        <select
          className={`border ${MAIN_COLOR.border} rounded-md p-2 ${MAIN_COLOR.text_color} ${MAIN_COLOR.bg} cursor-pointer`}
          value={selectedModel}
      ...
      {(() => {
        ...
        return (
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className={`p-4 bg-green-50 rounded-xl border border-green-200 ${MAIN_COLOR.text_color}`}>
            ...
            <div className={`p-4 bg-orange-50 rounded-xl border border-orange-200 ${MAIN_COLOR.text_color}`}>
        ...
        <div className={`border ${colorKey.border} rounded-lg overflow-hidden`}>
          <table className="w-full table-fixed border-collapse">
            <thead className={`${colorKey.bg_clair}`}>
              <tr>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>Model</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>Accuracy</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>AUC</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>F1 {valMetricType}</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>Precision {valMetricType}</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>Recall {valMetricType}</th>
              </tr>
            </thead>
            <tbody>
              {modelsData.map((model, i) => (
                <tr key={i} className={`${colorKey.hover_bg_50}`}>
                  <td className={`border-b ${colorKey.border} px-4 py-2 font-medium ${MAIN_COLOR.text_color}`}>{model.name}</td>
                  <td className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.text_color}`}>{model.val.accuracy}</td>
                  <td className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.text_color}`}>{model.val.auc}</td>
                  <td className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.text_color}`}>
          ...
          <table className="w-full table-fixed border-collapse">
            <thead className={`${colorKey.bg_clair}`}>
              <tr>
                ...
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>Accuracy</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>AUC</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>F1 {testMetricType}</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>Precision {testMetricType}</th>
                <th className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.subtitle_color}`}>Recall {testMetricType}</th>
              </tr>
            </thead>
            <tbody>
              {modelsData.map((model, i) => (
                <tr key={i} className={`${colorKey.hover_bg_50}`}>
                  <td className={`border-b ${colorKey.border} px-4 py-2 font-medium ${MAIN_COLOR.text_color}`}>{model.name}</td>
                  <td className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.text_color}`}>{model.test.accuracy}</td>
                  <td className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.text_color}`}>{model.test.auc}</td>
                  <td className={`border-b ${colorKey.border} px-4 py-2 ${MAIN_COLOR.text_color}`}>
